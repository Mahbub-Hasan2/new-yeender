...
const Vision = () => {
    ...
    return (
        <div id="C_about_vision_component_area">
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-md">
                        <img className="v_img img-fluid" src="https://i.imgur.com/y8lrH49.jpg" alt="" />
                    </div>
                    <div className="col-md">
                        <h3>
                        ...
                        <p>
                            ...
                            revenue. Our vision is to uphold the quality we&lsquo;re providing for the
